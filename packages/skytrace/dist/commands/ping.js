...
function fmt(val, padTo = 8) {
    return chalk.cyan(sprintf(`%-${padTo}s`, typeof val === 'number' ? val + 'ms' : val));
}
function parse(str) {
...
class PingCommand extends Command {
    ...
    async run() {
        ...
        // Headers:
        if (((_a = flags.headers) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            let headers = {};
        ...
        // Querystrings:
        if (((_b = flags.qs) === null || _b === void 0 ? void 0 : _b.length) > 0) {
            let qs = {};
        ...
        // Expectations:
        let checks = [];
        if (((_c = flags.expect) === null || _c === void 0 ? void 0 : _c.length) > 0) {
        ...
        try {
            ...
            const contentType = ((_d = context.vars.headers) === null || _d === void 0 ? void 0 : _d['content-type']) || 'application/octet-stream';
            ...
            if (checks.length > 0) {
                ...
                for (const ex of checks) {
                    ...
                    let result = artillery_plugin_expect_1.expectations[checker].call(this, ex, body, context.vars.req, context.vars.res, {});
                    results.push(result);
                }
...
PingCommand.aliases = ['probe', 'http'];
// Enable multiple args:
PingCommand.strict = false;
...
PingCommand.flags = {
    ...
    jmespath: flags.string({
        description: 'Run a JMESPath query on a JSON response body (https://docs.art/jmespath)'
    }),
